...
public class IdWorker {
	...
	private final static Map<String, IdWorker> m = new ConcurrentHashMap<String, IdWorker>();
	...
	public synchronized static long nextId(long workerId, long datacenterId) {
		...
		String zero = idStr.substring(0,1);
		if (zero.equals("0")){
			idStr = "1" + idStr.substring(1);
		}
	 ...
	 * default datacenterId:0
	 * 
	 * @return
	 */
	public synchronized static long nextId() {
		return IdWorker.nextId(0, 0);
